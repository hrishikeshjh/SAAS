    ...
    <div className="flex h-full w-full flex-col justify-center px-8 sm:px-12 lg:px-16">
      <div className="w-full max-w-md space-y-8">
        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          ...
          <div className="space-y-4 pt-4 animate-slide-in-right" style={{ animationDelay: '0.4s' }}>
            <Button
              type="submit"
        ...
        <p className="text-center text-sm text-muted-foreground animate-slide-in-right" style={{ animationDelay: '0.5s' }}>
